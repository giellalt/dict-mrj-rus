# Dictionary for mrj — rus

This repository contains source files for a dictionary from Western Mari to Russian. The content is licensed under the CC-BY-4.0 license.
